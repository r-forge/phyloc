...
\description{
  Methods for pruning phylogenies
}
\section{Methods}{
  \describe{
...
\usage{\S4methods{prune}{phylo4}(phy, tip, trim.internal = TRUE, subtree = FALSE,
         root.edge = 0)
}
\arguments{
...
r1 <- rcoal(5)
phylo4d(r1,tip.data=data.frame(1:5),node.data=data.frame(6:9))
phylo4d(r1,tip.data=data.frame(1:3),node.data=data.frame(6:9))
prune(r1,1)
}
\keyword{manip}
\keyword{methods}
