dropPhySim.tip <- function (phy, tip, trim.internal = TRUE, subtree = FALSE, root.edge = 0) 
{
### This function was written by Emmanuel Paradis for an old version of ape (<= ape 1.8-4) and is no longer in use by that package
### This function is used internally by several functions in package PhySim and does not need to be called by user.
